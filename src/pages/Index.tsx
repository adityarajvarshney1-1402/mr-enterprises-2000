        ...
        <section className="relative min-h-[85vh] flex items-center overflow-hidden">
          ...
          <div className="container-wide relative z-10">
            <div className="max-w-2xl">
              <motion.div 
                className="inline-flex items-center gap-2 px-4 py-2 bg-accent/20 text-accent-foreground rounded-full mb-6"
            ...
            <StaggerContainer className="grid md:grid-cols-3 gap-8">
              {features.map((feature) => (
                <StaggerItem key={feature.title}>
                  <div className="group p-8 bg-secondary rounded-lg hover:bg-kraft-light transition-all duration-300">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <ScrollReveal direction="right" delay={0.2}>
                <div className="relative">
                  ...
                  />
                  <motion.div 
                    className="absolute -bottom-6 -left-6 bg-accent text-accent-foreground p-6 rounded-lg hidden md:block"
